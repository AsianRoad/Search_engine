...
class Query:
    ...
    def __init__(self,filenames):
        ...
        self.index = build_chi_index.BuildIndex(self.filenames)
...
q = Query(['E:\\search_engine\\corpus\\chi1.txt','E:\\search_engine\\corpus\\chi2.txt'])

print  q.phrase_query('英雄 反驳 故事'.decode('utf-8'))
